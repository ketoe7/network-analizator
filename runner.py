...
def main(nano_machines_amounts, iteration_number, router_position, vein, collision):
    ...
    final_results = {}
    # print(f'initial results_per_nano_nodes_number: {results_per_nano_nodes_number}')
    ...
    for machines_amount in nano_machines_amounts:
        ...
        for _ in range(iteration_number):
            ...
            simulator = Simulator(iteration_number, logger, cephalic_vein.length/4.8*0.0056*machines_amount, vein, transmission_radius_range,
            ...
            success, failed, collisions = simulator.run_new_simulation()
            ...
            # print(f'results_per_nano_nodes_number: {results_per_nano_nodes_number}')
        ...
        logger.info(indent(f'Average amount of transmissions per minute for {machines_amount} nano machines: {sum(results_per_nano_nodes_number)/len(results_per_nano_nodes_number)}', 2))
        logger.info(indent(f'Average amount of collisions per minute for {machines_amount} nano machines: {sum(collisions_per_nano_nodes_number)/len(collisions_per_nano_nodes_number)}', 2))
